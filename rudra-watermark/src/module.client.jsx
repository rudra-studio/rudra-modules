...
export default function CompiledModule(props) {
  ...
  return (
    <div ref={wrapperRef} className="rudra-module-wrapper">
      ...
      <RudraCoreTypography id="watermark_glass_label" className={`${getResponsiveProp({sm: 'text-xs font-semibold tracking-tight text-slate-700 dark:text-slate-100'}) || ''}`} as="span" content={getResponsiveProp({"sm":"Built with Rudra"})} />
</RudraCoreLink>
