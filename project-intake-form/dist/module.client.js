...
import { Card as yt, Typography as g, Alert as ht, Divider as pt, Button as V } from "@rudra-studio/rudra-core";
import { Form as wt, FormSection as I, Input as jt, Textarea as _t, Select as P, DatePicker as H, CurrencyInput as Ot, ValidationSummary as At } from "@rudra-studio/rudra-form";
import { Container as xt, Grid as G, Flex as St } from "@rudra-studio/rudra-layout";
function vt(r) {
  ...
  const n = A((t) => typeof t != "object" || t === null ? t : E === "sm" ? t.sm !== void 0 ? t.sm : t.md !== void 0 ? t.md : t.lg : E === "md" ? t.md !== void 0 ? t.md : t.sm !== void 0 ? t.sm : t.lg : t.lg !== void 0 ? t.lg : t.md !== void 0 ? t.md : t.sm, [E]), B = r.project !== void 0 ? r.project : r.data?.project !== void 0 ? r.data.project : void 0, et = r.mode !== void 0 ? r.mode : r.data?.mode !== void 0 ? r.data.mode : "create", rt = r.domainUrl !== void 0 ? r.domainUrl : r.data?.domainUrl !== void 0 ? r.data.domainUrl : "https://rudra-sql.onrender.com", L = r.clients !== void 0 ? r.clients : r.data?.clients !== void 0 ? r.data.clients : [], it = r.workspaceId !== void 0 ? r.workspaceId : r.data?.workspaceId !== void 0 ? r.data.workspaceId : void 0, nt = { project: B, mode: et, domainUrl: rt, clients: L, workspaceId: it }, [q, M] = D(() => structuredClone(!1)), [ot, F] = D(() => structuredClone(!1)), at = { submitting: q, hasError: ot }, O = A((t, e) => {
    switch (t) {
      case "submitting":
        return M(e), e;
      case "hasError":
  ...
  return /* @__PURE__ */ c("div", { ref: k, className: "rudra-module-wrapper", children: /* @__PURE__ */ d(xt, { id: "project-form-container", className: `${n({ sm: "w-full rudra-module-wrapper" }) || ""}`, as: "section", centered: !0, maxWidth: "lg", children: [
    "      ",
    /* @__PURE__ */ d(yt, { id: "project-form-card", className: `${n({ sm: "w-full overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-slate-700 dark:bg-slate-900 p-2" }) || ""}`, as: "section", theme: "auto", children: [
      "      ",
      /* @__PURE__ */ d(wt, { id: "project-form", initialValues: B, onSubmit: (...t) => Z("handleSubmit", {}, t), children: [
        "      ",
        ...
        ] }), defaultCollapsed: !1, actions: !1, density: "comfortable", variant: n({ sm: "filled" }), collapsible: !1, children: [
          "      ",
          /* @__PURE__ */ c(jt, { id: "project-name", className: `${n({ sm: "mb-4 border-zinc-300" }) || ""} ${n({ sm: "rounded-md" }) || ""}`, icon: !1, name: "name", size: "md", required: !0, label: "Project name", variant: "default", placeholder: "Website redesign", iconPosition: "start" }),
          /* @__PURE__ */ c(_t, { id: "project-description", placeholder: "Describe what the team is building...", name: "description", size: "md", label: "Description · Optional", maxRows: 8, minRows: 5, variant: "default", autoResize: !0 }),
          /* @__PURE__ */ c(P, { id: "project-client", className: `${n({ sm: "mb-4" }) || ""}`, size: "md", label: "Client · Optional", radius: "lg", shadow: "sm", options: L, colorScheme: "slate", name: "clientId" })
        ] }),
        /* @__PURE__ */ d(I, { id: "details-section", title: /* @__PURE__ */ d(_, { children: [
          ...
          "      ",
          /* @__PURE__ */ d(G, { id: "details-grid", className: "grid w-full grid-cols-1 gap-5 sm:grid-cols-2", as: "div", children: [
            "      ",
            /* @__PURE__ */ c(P, { id: "project-status", colorScheme: "slate", name: "status", size: "md", label: "Status", radius: "lg", shadow: "sm", options: [{ label: "Planning", value: "PLANNING" }, { label: "Active", value: "ACTIVE" }, { label: "On hold", value: "ON_HOLD" }, { label: "Completed", value: "COMPLETED" }], required: !0 }),
            /* @__PURE__ */ c(P, { id: "project-priority", options: [{ label: "Low", value: "LOW" }, { label: "Medium", value: "MEDIUM" }, { label: "High", value: "HIGH" }, { label: "Critical", value: "CRITICAL" }], required: !0, colorScheme: "slate", name: "priority", size: "md", label: "Priority", radius: "lg", shadow: "sm" })
          ] })
        ] }),
        /* @__PURE__ */ d(I, { id: "schedule-section", description: /* @__PURE__ */ d(_, { children: [
          "      ",
          ...
          "      ",
          /* @__PURE__ */ d(G, { id: "date-grid", className: "grid w-full grid-cols-1 gap-5 sm:grid-cols-2", as: "div", children: [
            "      ",
            /* @__PURE__ */ c(H, { id: "project-start-date", name: "startDate", size: "md", label: "Start date", variant: "default", clearable: !0 }),
            /* @__PURE__ */ c(H, { id: "project-due-date", name: "dueDate", size: "md", label: "Due date", variant: "default", clearable: !0 })
          ] }),
          /* @__PURE__ */ c(Ot, { id: "project-budget", name: "budget", locale: n({ sm: "en-US" }), prefix: !1, minimumFractionDigits: 0, size: "md", label: "Budget · Optional", suffix: !1, variant: "default", currency: "INR", clampOnBlur: !0, allowNegative: !1, maximumFractionDigits: 2 })
        ] }),
        /* @__PURE__ */ c(At, { id: "validation-summary", className: "mx-6 mb-6 sm:mx-8", live: n({ sm: "polite" }), title: "", errors: W?.errors, fieldLabels: { budget: "Budget", dueDate: "Due date", name: "Project name" }, focusFieldOnClick: !0 }),
        /* @__PURE__ */ d(ht, { id: "success-alert", title: /* @__PURE__ */ d(_, { children: [
          "      ",
        ...
        ] }), icon: !1, live: "polite", appearance: "soft", dismissible: !1, theme: "auto", action: !1, variant: n({ sm: "error" }), children: [
          "      ",
          /* @__PURE__ */ c(g, { id: "el_1786794841585_yu8l08l", content: "Hello Thereee" })
        ] }),
        /* @__PURE__ */ c(pt, { id: "el_1786789281745_tl38ipo" }),
        /* @__PURE__ */ d(St, { id: "form-actions", className: `${n({ sm: "project-form-actions flex justify-end gap-2" }) || ""}`, align: "center", justify: "end", direction: "horizontal", as: "div", gap: "3", wrap: !0, children: [
          "      ",
          /* @__PURE__ */ d(V, { id: "cancel-button", className: `${n({ sm: "h-10 rounded-lg border border-zinc-300 bg-white px-4 text-sm font-medium text-zinc-700 shadow-sm transition hover:bg-zinc-50 disabled:opacity-50" }) || ""}`, id: "project-form-cancel", size: "md", theme: "auto", onAction: (...t) => Z("handleCancel", {}, t), rightIcon: !1, variant: "outline", leftIcon: !1, children: [
            "      ",
          ...
          /* @__PURE__ */ d(V, { id: "submit-button", className: `flex ${n({ sm: "inline-flex h-10 items-center justify-center gap-2 rounded-lg bg-zinc-950 px-5 text-sm font-medium text-white shadow-sm transition hover:bg-zinc-800 disabled:cursor-not-allowed disabled:opacity-60" }) || ""}`, size: "md", theme: "auto", loading: q, variant: "primary", leftIcon: !1, onAction: null, id: "project-form-submit", type: "submit", rightIcon: !1, loadingText: "Saving...", children: [
            "      ",
