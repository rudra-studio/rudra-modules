...
export default function CompiledModule(props) {
  ...
  async function validate(initialArgs = {}) {
    ...
    if (form === "login") {
      ...
      vars["isPasswordMatched"] = await _callLibrary("https://cdn.jsdelivr.net/npm/@rudra-studio/rudra-core@1.0.67/utils/IsEqual.js", "IsEqual", { "source": argss.inputVaues.password, "target": args.inputValues.confirmPassword });
