...
import { Box, Repeater } from '@rudra-studio/rudra-layout';
import { OptimizedImage } from '@rudra-studio/rudra-media';
import { Typography, Link } from '@rudra-studio/rudra-core';
import { TypewriterText, TextScramble, Marquee, FlipTile } from '@rudra-studio/rudra-anim';
...
export default function CompiledModule(props) {
  ...
  return (
    <div className="rudra-module-wrapper">
      <Box id="el_1783116382087_hktrke1" customAttributes={[]} Gap={{"lg":"6","md":"6","sm":"6"}} Direction={{"lg":"col","sm":"col"}} className={{"sm":"min-h-screen bg-slate-50 text-slate-800 font-sans selection:bg-blue-100 pb-20 w-full"}}>
      <Box id="el_1783117555351_vqxm7ws" Align (Cross Axis)={{"lg":"end","md":"end","sm":"start"}} Justify (Main Axis)={{"sm":"between"}} Gap={{"lg":"2","md":"2","sm":"2"}} Direction={{"lg":"row","md":"row","sm":"col"}} className={{"sm":"max-w-6xl px-4 mx-auto w-full"}} customAttributes={[]}>
      ...
      <Typography id="el_1783118024559_oain35d" as="h2" Size={{"lg":"6xl","md":"6xl","sm":"5xl"}} Weight={{"sm":"extrabold"}} className={{"sm":"text-slate-900 tracking-tight leading-none mb-3"}}>
      </Typography>
      <TypewriterText id="el_1783118365991_ifo3jxo" as="h2" Size={{"lg":"xl","md":"xl","sm":"lg"}} loop={{"sm":"false"}} Weight={{"sm":"medium"}} className={{"sm":"max-w-xl mb-6"}} customColor={{"sm":"#0078ed"}} hideCursorOnComplete="true" delay={{"sm":0}} loopDelay={{"sm":10000000}} showCursor="true" customAttributes={[]}>
      </TypewriterText>
      <Repeater id="el_1783122541120_f986kyx" Wrap Content={{"lg":"wrap","md":"wrap","sm":"wrap"}} Flex Direction={{"lg":"row","md":"row","sm":"row"}} Align (Cross Axis)={{"sm":"center"}} Gap={{"lg":"2","md":"2"}} gap="sm" layout={{"lg":"flex","sm":"flex"}} columns={{"lg":3,"sm":0}} className={{"sm":"gap-4 text-sm text-slate-500 font-medium"}}>
      <Box id="el_1783122592136_aq1kex8" customAttributes={[]} className={{"sm":"text-sm text-slate-500 font-medium"}}>
      <Link id="el_1783122688079_k0fh8s3" leftIcon={false} className={[]} rightIcon={false} customAttributes={[]}>
      <div id="el_1783122598744_x2wce06" size={20} color="#111827" strokeWidth={1.2}>
      </div>
      <Typography id="el_1783122719647_pyybzh6" as="h2" className={{"sm":"text-sm text-slate-500 font-medium"}}>
      </Typography>
      </Link>
      </Box>
      </Repeater>
      </Box>
      <Box id="el_1783117701363_ocxzll6" customAttributes={[]} className={[]}>
      <Box id="el_1783123659603_5wvhewk" className={{"sm":"bg-white border border-slate-200 rounded-3xl p-6 shadow-sm gap-5 shrink-0 hover:shadow-md transition-shadow"}} customAttributes={[]} Align (Cross Axis)={{"sm":"center"}}>
      <TextScramble id="el_1783123741703_5dkfvtb" Size={{"sm":"5xl"}} Weight={{"sm":"extrabold"}} trigger="onMount" className={{"sm":"font-black text-blue-600"}} customAttributes={[]} as="h2">
      </TextScramble>
      <Box id="el_1783123833648_v21toav" Direction={{"sm":"col"}} className={[]} customAttributes={[]}>
      <Typography id="el_1783123877120_h7spqiy" as="h2" Size={{"sm":"sm"}} Weight={{"sm":"bold"}} content={{"sm":"YEARS"}} className={{"sm":"text-slate-800 uppercase tracking-widest"}}>
      </Typography>
      ...
      <Marquee id="el_1783124249993_7ltc9uh" className={{"sm":"overflow-hidden border-y border-slate-200 py-5 bg-white mb-8 shadow-sm"}} pauseOnHover="true" speed={{"lg":6,"sm":3}} direction="left" pauseAnimation={false} trackClassName={[]} customAttributes={[]}>
      <Repeater id="el_1783296242762_o8s63fo" layout={{"lg":"flex","sm":"flex"}} className={[]} Gap={{"lg":"0","sm":"2"}}>
      <Box id="el_1783296267155_t2j26td" Gap={{"lg":"2","sm":"2"}} className={{"lg":"text-sm font-semibold tracking-widest text-slate-400 mx-4 uppercase","md":"text-sm font-semibold tracking-widest text-slate-400 mx-4 "}} customAttributes={[]} Align (Cross Axis)={{"lg":"center","sm":"center"}}>
      <div id="el_1783296303075_i48zyfb" strokeWidth={1.2} name="CircleStar" size={20} color="#111827">
      </div>
      ...
      <FlipTile id="el_1783319052953_6orgl0c" hasBackContent={{"lg":true,"sm":{"dataPath":"item.moreContent","type":"binding"}}} customAttributes={[]} Height={{"lg":"64","md":"64"}} className={{"lg":"flex-1","md":" flex-1","sm":"h-full"}} direction="horizontal" backContent={null}>
      <Box id="el_1783337050148_7chjh7v" customAttributes={[]} Direction={{"lg":"col","md":"col","sm":"col"}} className={{"lg":"p-4","md":"p-4","sm":"p-4"}}>
      ...
      <Typography id="el_1783338052372_0u1gg50" className={{"lg":"text-sm text-slate-500","md":"text-sm text-slate-500","sm":"text-sm text-slate-500"}} as="h2">
      </Typography>
      <Typography id="el_1783338058221_rd2bncg" className={{"lg":"text-md","sm":"text-xs text-slate-600 leading-relaxed mb-4 flex-1"}} as="h2" Size={{"lg":"base"}}>
      </Typography>
      </Box>
      <Box id="el_1783339928997_gw2xmmv" Direction={{"sm":"col"}} className={{"sm":"h-full p-4"}} customAttributes={[]}>
      <Typography id="el_1783340211173_f694ofw" className={{"sm":"text-sm font-bold text-slate-900 mb-2"}} as="h2">
      </Typography>
      ...
      <Box id="el_1783343648304_oa6zsul" Justify (Main Axis)={{"sm":"between"}} Direction={{"sm":"row"}} className={{"sm":"p-6 bg-slate-50 gap-4 border-b border-slate-200"}} customAttributes={[]} Align (Cross Axis)={{"sm":"center"}}>
      ...
      <Typography id="el_1783343985129_6wlfb2z" as="h2" content={{"sm":"Play this mini-game to unlock fun facts about me."}} className={{"sm":"text-sm text-slate-500 mt-1 font-medium"}}>
      </Typography>
      </Box>
      </Box>
      <Box id="el_1783343630200_wklm9b7" className={{"lg":"h-screen"}} customAttributes={[]}>
