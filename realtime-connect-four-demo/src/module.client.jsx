...
invite.searchParams.set("roomId",roomId);
...
if(hostingRoom&&!joiningRoom){
  ...
  invite.searchParams.set("roomId",hostingRoom);
...
const registry=window.RudraSharedState;const api=registry?.current||registry;if(!api?.get||!api?.set)return;const game=api.get("game");if(!game)return;const runtimePlayers=window.__rudraConnectFourPlayers;const playerId=runtimePlayers?.[api.roomId];if(game.players?.red!==playerId&&game.players?.yellow!==playerId)return;const next={...game,board:Array(42).fill("○"),turn:"🔴",winner:null,moves:0,revision:Number(game.revision||0)+1,status:game.players?.yellow?"Turn: 🔴":"Waiting for Yellow player…"};api.set("game",next);return next;
  ...
  return (
    <div ref={wrapperRef} className="rudra-module-wrapper">
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_root" className="connect-four-shell">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_panel" className="connect-four-panel">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreTypography id="c4_kicker" className="connect-four-kicker" as="p" content="RUDRA SHARED STATE · LIVE ROOM" />
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreTypography id="c4_title" className="connect-four-title" as="h2" content="CONNECT FOUR" />
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreTypography id="c4_intro" className="connect-four-intro" as="p" content="This reusable module joins the roomId supplied by its application. Share the application URL configured for that room; Red moves first." />
</>)}
      {isVisibleValue(inputs?.inviteRoomId) && (<>      <RudraLayoutBox id="c4_invite_row" className="connect-four-invite">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreTypography id="c4_invite_url" className="connect-four-invite-url" as="p" content={((_bindingValue) => _bindingValue === undefined ? "Creating invite link…" : _bindingValue)(inviteUrl)} />
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_copy_invite_button" aria-label="Copy invite URL" className="connect-four-copy" role="button" onClick={(...eventArgs) => _callAction("copyInviteUrl", {}, eventArgs)} tabIndex={0}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreTypography id="c4_copy_invite_label" className="connect-four-inline-label" as="span" content="Copy invite" />
</>)}
</RudraLayoutBox>
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_status_box" className="connect-four-status">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_status" className="connect-four-status-text">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreTypography id="c4_status_label" className="connect-four-inline-label" as="span" content={((_bindingValue) => _bindingValue === undefined ? "Waiting for second player…" : _bindingValue)(sharedState?.game?.status)} />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_players" className="connect-four-players">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreTypography id="c4_players_label" className="connect-four-inline-label" as="span" content={((_bindingValue) => _bindingValue === undefined ? "🔴 Red open · 🟡 Yellow open" : _bindingValue)(sharedState?.game?.playersLabel)} />
</>)}
</RudraLayoutBox>
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutGrid id="c4_board" className="connect-four-board" as="div" columns={6}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_0" aria-label="Drop a disc in column 1" className="connect-four-cell" role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 0}, eventArgs)} tabIndex={0}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_0" className="connect-four-disc-anim" height="82%" paused={false} preload={true} autoPlay={true} animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[0])} objectFit="contain" alt="" width="82%" animations={spriteAnimations} imageClassName="connect-four-disc-image" imageRendering="auto" speed={1} />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_1" aria-label="Drop a disc in column 2" className="connect-four-cell" tabIndex={0} role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 1}, eventArgs)}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_1" className="connect-four-disc-anim" preload={true} animations={spriteAnimations} imageClassName="connect-four-disc-image" speed={1} paused={false} autoPlay={true} animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[1])} objectFit="contain" imageRendering="auto" alt="" width="82%" height="82%" />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_2" aria-label="Drop a disc in column 3" className="connect-four-cell" role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 2}, eventArgs)} tabIndex={0}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_2" className="connect-four-disc-anim" alt="" height="82%" paused={false} animations={spriteAnimations} imageClassName="connect-four-disc-image" imageRendering="auto" speed={1} width="82%" preload={true} autoPlay={true} animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[2])} objectFit="contain" />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_3" aria-label="Drop a disc in column 4" className="connect-four-cell" role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 3}, eventArgs)} tabIndex={0}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_3" className="connect-four-disc-anim" paused={false} preload={true} autoPlay={true} imageClassName="connect-four-disc-image" speed={1} height="82%" animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[3])} objectFit="contain" animations={spriteAnimations} imageRendering="auto" alt="" width="82%" />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_4" aria-label="Drop a disc in column 5" className="connect-four-cell" role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 4}, eventArgs)} tabIndex={0}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_4" className="connect-four-disc-anim" animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[4])} height="82%" objectFit="contain" animations={spriteAnimations} imageClassName="connect-four-disc-image" imageRendering="auto" alt="" speed={1} width="82%" paused={false} preload={true} autoPlay={true} />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_5" aria-label="Drop a disc in column 6" className="connect-four-cell" role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 5}, eventArgs)} tabIndex={0}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_5" className="connect-four-disc-anim" width="82%" paused={false} preload={true} animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[5])} objectFit="contain" height="82%" autoPlay={true} animations={spriteAnimations} imageClassName="connect-four-disc-image" imageRendering="auto" alt="" speed={1} />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_6" aria-label="Drop a disc in column 7" className="connect-four-cell" role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 6}, eventArgs)} tabIndex={0}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_6" className="connect-four-disc-anim" animations={spriteAnimations} imageRendering="auto" alt="" width="82%" animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[6])} imageClassName="connect-four-disc-image" speed={1} height="82%" paused={false} preload={true} autoPlay={true} objectFit="contain" />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_7" aria-label="Drop a disc in column 1" className="connect-four-cell" role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 0}, eventArgs)} tabIndex={0}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_7" className="connect-four-disc-anim" preload={true} animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[7])} objectFit="contain" alt="" height="82%" paused={false} autoPlay={true} animations={spriteAnimations} imageClassName="connect-four-disc-image" imageRendering="auto" speed={1} width="82%" />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_8" aria-label="Drop a disc in column 2" className="connect-four-cell" onClick={(...eventArgs) => _callAction("playColumn", {"column": 1}, eventArgs)} tabIndex={0} role="button">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_8" className="connect-four-disc-anim" height="82%" paused={false} autoPlay={true} animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[8])} animations={spriteAnimations} imageRendering="auto" speed={1} width="82%" preload={true} objectFit="contain" imageClassName="connect-four-disc-image" alt="" />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_9" aria-label="Drop a disc in column 3" className="connect-four-cell" role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 2}, eventArgs)} tabIndex={0}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_9" className="connect-four-disc-anim" imageRendering="auto" alt="" speed={1} width="82%" height="82%" autoPlay={true} animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[9])} animations={spriteAnimations} imageClassName="connect-four-disc-image" paused={false} preload={true} objectFit="contain" />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_10" aria-label="Drop a disc in column 4" className="connect-four-cell" role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 3}, eventArgs)} tabIndex={0}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_10" className="connect-four-disc-anim" preload={true} objectFit="contain" imageClassName="connect-four-disc-image" imageRendering="auto" alt="" height="82%" autoPlay={true} animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[10])} animations={spriteAnimations} speed={1} width="82%" paused={false} />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_11" aria-label="Drop a disc in column 5" className="connect-four-cell" role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 4}, eventArgs)} tabIndex={0}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_11" className="connect-four-disc-anim" objectFit="contain" animations={spriteAnimations} imageClassName="connect-four-disc-image" alt="" height="82%" preload={true} autoPlay={true} animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[11])} imageRendering="auto" speed={1} width="82%" paused={false} />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_12" aria-label="Drop a disc in column 6" className="connect-four-cell" tabIndex={0} role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 5}, eventArgs)}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_12" className="connect-four-disc-anim" speed={1} paused={false} preload={true} autoPlay={true} objectFit="contain" animations={spriteAnimations} imageClassName="connect-four-disc-image" alt="" width="82%" height="82%" animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[12])} imageRendering="auto" />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_13" aria-label="Drop a disc in column 7" className="connect-four-cell" role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 6}, eventArgs)} tabIndex={0}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_13" className="connect-four-disc-anim" alt="" speed={1} width="82%" height="82%" paused={false} autoPlay={true} objectFit="contain" preload={true} animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[13])} animations={spriteAnimations} imageClassName="connect-four-disc-image" imageRendering="auto" />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_14" aria-label="Drop a disc in column 1" className="connect-four-cell" role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 0}, eventArgs)} tabIndex={0}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_14" className="connect-four-disc-anim" animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[14])} objectFit="contain" animations={spriteAnimations} imageRendering="auto" alt="" speed={1} height="82%" preload={true} autoPlay={true} imageClassName="connect-four-disc-image" width="82%" paused={false} />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_15" aria-label="Drop a disc in column 2" className="connect-four-cell" role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 1}, eventArgs)} tabIndex={0}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_15" className="connect-four-disc-anim" preload={true} autoPlay={true} animations={spriteAnimations} imageClassName="connect-four-disc-image" imageRendering="auto" alt="" speed={1} animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[15])} objectFit="contain" width="82%" height="82%" paused={false} />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_16" aria-label="Drop a disc in column 3" className="connect-four-cell" role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 2}, eventArgs)} tabIndex={0}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_16" className="connect-four-disc-anim" imageClassName="connect-four-disc-image" imageRendering="auto" alt="" speed={1} height="82%" autoPlay={true} objectFit="contain" animations={spriteAnimations} width="82%" paused={false} preload={true} animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[16])} />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_17" aria-label="Drop a disc in column 4" className="connect-four-cell" role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 3}, eventArgs)} tabIndex={0}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_17" className="connect-four-disc-anim" preload={true} animations={spriteAnimations} imageClassName="connect-four-disc-image" height="82%" autoPlay={true} animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[17])} objectFit="contain" imageRendering="auto" alt="" speed={1} width="82%" paused={false} />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_18" aria-label="Drop a disc in column 5" className="connect-four-cell" role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 4}, eventArgs)} tabIndex={0}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_18" className="connect-four-disc-anim" width="82%" height="82%" paused={false} animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[18])} imageClassName="connect-four-disc-image" alt="" preload={true} autoPlay={true} objectFit="contain" animations={spriteAnimations} imageRendering="auto" speed={1} />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_19" aria-label="Drop a disc in column 6" className="connect-four-cell" tabIndex={0} role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 5}, eventArgs)}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_19" className="connect-four-disc-anim" imageClassName="connect-four-disc-image" speed={1} paused={false} preload={true} autoPlay={true} objectFit="contain" animations={spriteAnimations} imageRendering="auto" alt="" width="82%" height="82%" animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[19])} />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_20" aria-label="Drop a disc in column 7" className="connect-four-cell" role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 6}, eventArgs)} tabIndex={0}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_20" className="connect-four-disc-anim" alt="" width="82%" height="82%" preload={true} animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[20])} animations={spriteAnimations} speed={1} paused={false} autoPlay={true} objectFit="contain" imageClassName="connect-four-disc-image" imageRendering="auto" />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_21" aria-label="Drop a disc in column 1" className="connect-four-cell" tabIndex={0} role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 0}, eventArgs)}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_21" className="connect-four-disc-anim" objectFit="contain" imageRendering="auto" speed={1} height="82%" paused={false} autoPlay={true} animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[21])} animations={spriteAnimations} imageClassName="connect-four-disc-image" alt="" width="82%" preload={true} />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_22" aria-label="Drop a disc in column 2" className="connect-four-cell" role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 1}, eventArgs)} tabIndex={0}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_22" className="connect-four-disc-anim" speed={1} width="82%" height="82%" autoPlay={true} objectFit="contain" imageClassName="connect-four-disc-image" imageRendering="auto" alt="" paused={false} preload={true} animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[22])} animations={spriteAnimations} />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_23" aria-label="Drop a disc in column 3" className="connect-four-cell" onClick={(...eventArgs) => _callAction("playColumn", {"column": 2}, eventArgs)} tabIndex={0} role="button">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_23" className="connect-four-disc-anim" alt="" speed={1} height="82%" autoPlay={true} objectFit="contain" animations={spriteAnimations} imageClassName="connect-four-disc-image" width="82%" paused={false} preload={true} animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[23])} imageRendering="auto" />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_24" aria-label="Drop a disc in column 4" className="connect-four-cell" role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 3}, eventArgs)} tabIndex={0}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_24" className="connect-four-disc-anim" objectFit="contain" animations={spriteAnimations} width="82%" height="82%" preload={true} imageClassName="connect-four-disc-image" imageRendering="auto" alt="" speed={1} paused={false} autoPlay={true} animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[24])} />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_25" aria-label="Drop a disc in column 5" className="connect-four-cell" tabIndex={0} role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 4}, eventArgs)}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_25" className="connect-four-disc-anim" height="82%" animations={spriteAnimations} imageClassName="connect-four-disc-image" speed={1} paused={false} preload={true} autoPlay={true} animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[25])} objectFit="contain" imageRendering="auto" alt="" width="82%" />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_26" aria-label="Drop a disc in column 6" className="connect-four-cell" role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 5}, eventArgs)} tabIndex={0}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_26" className="connect-four-disc-anim" height="82%" paused={false} preload={true} autoPlay={true} animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[26])} animations={spriteAnimations} alt="" objectFit="contain" imageClassName="connect-four-disc-image" imageRendering="auto" speed={1} width="82%" />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_27" aria-label="Drop a disc in column 7" className="connect-four-cell" role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 6}, eventArgs)} tabIndex={0}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_27" className="connect-four-disc-anim" paused={false} animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[27])} objectFit="contain" imageClassName="connect-four-disc-image" alt="" height="82%" preload={true} autoPlay={true} animations={spriteAnimations} imageRendering="auto" speed={1} width="82%" />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_28" aria-label="Drop a disc in column 1" className="connect-four-cell" role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 0}, eventArgs)} tabIndex={0}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_28" className="connect-four-disc-anim" animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[28])} animations={spriteAnimations} height="82%" paused={false} preload={true} objectFit="contain" imageClassName="connect-four-disc-image" imageRendering="auto" alt="" speed={1} width="82%" autoPlay={true} />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_29" aria-label="Drop a disc in column 2" className="connect-four-cell" tabIndex={0} role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 1}, eventArgs)}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_29" className="connect-four-disc-anim" width="82%" preload={true} autoPlay={true} animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[29])} imageRendering="auto" alt="" height="82%" paused={false} objectFit="contain" animations={spriteAnimations} imageClassName="connect-four-disc-image" speed={1} />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_30" aria-label="Drop a disc in column 3" className="connect-four-cell" role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 2}, eventArgs)} tabIndex={0}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_30" className="connect-four-disc-anim" preload={true} autoPlay={true} animations={spriteAnimations} imageRendering="auto" alt="" width="82%" height="82%" paused={false} animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[30])} objectFit="contain" imageClassName="connect-four-disc-image" speed={1} />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_31" aria-label="Drop a disc in column 4" className="connect-four-cell" role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 3}, eventArgs)} tabIndex={0}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_31" className="connect-four-disc-anim" alt="" speed={1} width="82%" height="82%" paused={false} animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[31])} objectFit="contain" preload={true} autoPlay={true} animations={spriteAnimations} imageClassName="connect-four-disc-image" imageRendering="auto" />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_32" aria-label="Drop a disc in column 5" className="connect-four-cell" role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 4}, eventArgs)} tabIndex={0}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_32" className="connect-four-disc-anim" width="82%" height="82%" imageClassName="connect-four-disc-image" imageRendering="auto" alt="" speed={1} paused={false} preload={true} autoPlay={true} animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[32])} objectFit="contain" animations={spriteAnimations} />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_33" aria-label="Drop a disc in column 6" className="connect-four-cell" onClick={(...eventArgs) => _callAction("playColumn", {"column": 5}, eventArgs)} tabIndex={0} role="button">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_33" className="connect-four-disc-anim" speed={1} paused={false} animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[33])} objectFit="contain" imageRendering="auto" alt="" width="82%" height="82%" preload={true} autoPlay={true} animations={spriteAnimations} imageClassName="connect-four-disc-image" />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_34" aria-label="Drop a disc in column 7" className="connect-four-cell" role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 6}, eventArgs)} tabIndex={0}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_34" className="connect-four-disc-anim" preload={true} autoPlay={true} animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[34])} imageClassName="connect-four-disc-image" speed={1} width="82%" height="82%" objectFit="contain" animations={spriteAnimations} imageRendering="auto" alt="" paused={false} />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_35" aria-label="Drop a disc in column 1" className="connect-four-cell" role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 0}, eventArgs)} tabIndex={0}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_35" className="connect-four-disc-anim" width="82%" height="82%" paused={false} autoPlay={true} animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[35])} objectFit="contain" alt="" preload={true} animations={spriteAnimations} imageClassName="connect-four-disc-image" imageRendering="auto" speed={1} />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_36" aria-label="Drop a disc in column 2" className="connect-four-cell" role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 1}, eventArgs)} tabIndex={0}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_36" className="connect-four-disc-anim" animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[36])} imageClassName="connect-four-disc-image" alt="" speed={1} height="82%" paused={false} objectFit="contain" animations={spriteAnimations} imageRendering="auto" width="82%" preload={true} autoPlay={true} />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_37" aria-label="Drop a disc in column 3" className="connect-four-cell" role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 2}, eventArgs)} tabIndex={0}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_37" className="connect-four-disc-anim" paused={false} autoPlay={true} objectFit="contain" animations={spriteAnimations} imageClassName="connect-four-disc-image" alt="" speed={1} width="82%" height="82%" preload={true} animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[37])} imageRendering="auto" />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_38" aria-label="Drop a disc in column 4" className="connect-four-cell" tabIndex={0} role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 3}, eventArgs)}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_38" className="connect-four-disc-anim" objectFit="contain" animations={spriteAnimations} speed={1} paused={false} autoPlay={true} animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[38])} imageClassName="connect-four-disc-image" imageRendering="auto" alt="" width="82%" height="82%" preload={true} />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_39" aria-label="Drop a disc in column 5" className="connect-four-cell" tabIndex={0} role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 4}, eventArgs)}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_39" className="connect-four-disc-anim" height="82%" animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[39])} objectFit="contain" animations={spriteAnimations} imageClassName="connect-four-disc-image" imageRendering="auto" alt="" width="82%" paused={false} preload={true} autoPlay={true} speed={1} />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_40" aria-label="Drop a disc in column 6" className="connect-four-cell" role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 5}, eventArgs)} tabIndex={0}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_40" className="connect-four-disc-anim" autoPlay={true} objectFit="contain" imageClassName="connect-four-disc-image" alt="" speed={1} animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[40])} animations={spriteAnimations} imageRendering="auto" width="82%" height="82%" paused={false} preload={true} />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_cell_41" aria-label="Drop a disc in column 7" className="connect-four-cell" role="button" onClick={(...eventArgs) => _callAction("playColumn", {"column": 6}, eventArgs)} tabIndex={0}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraThreeSpriteAnimator id="c4_disc_41" className="connect-four-disc-anim" width="82%" paused={false} objectFit="contain" animations={spriteAnimations} imageRendering="auto" alt="" height="82%" preload={true} autoPlay={true} animation={((_bindingValue) => _bindingValue === undefined ? "○" : _bindingValue)(sharedState?.game?.board?.[41])} imageClassName="connect-four-disc-image" speed={1} />
</>)}
</RudraLayoutBox>
</>)}
</RudraLayoutGrid>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_footer" className="connect-four-footer">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_reset" className="connect-four-reset" role="button" onClick={(...eventArgs) => _callAction("resetGame", {}, eventArgs)} tabIndex={0}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreTypography id="c4_reset_label" className="connect-four-reset-label" as="span" content="Reset shared game" />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="c4_connection" className="connect-four-connection">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreTypography id="c4_connection_label" className="connect-four-inline-label" as="span" content={((_bindingValue) => _bindingValue === undefined ? "connecting" : _bindingValue)(sharedState?.status)} />
</>)}
</RudraLayoutBox>
</>)}
</RudraLayoutBox>
