...
import { Button as RudraCoreButton, Typography as RudraCoreTypography, Link as RudraCoreLink, Badge as RudraCoreBadge } from '@rudra-studio/rudra-core';
...
export default function CompiledModule(props) {
  ...
  return (
    <div ref={wrapperRef} className="rudra-module-wrapper">
      ...
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="header" role="banner" className="block rs-shell-header">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="header_inner" className="block rs-shell-header-inner">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreButton id="brand" className="rs-shell-brand" theme="auto" leftIcon={false} onAction={(...eventArgs) => _callAction("navigate", {}, eventArgs)} rightIcon={false} id="brand" label="Rudra Scholar" />
</>)}
      ...
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreButton id="pricing" className="rs-shell-button" onAction={(...eventArgs) => _callAction("navigate", {}, eventArgs)} rightIcon={false} id="pricing" label="Learning time" theme="auto" leftIcon={false} />
</>)}
      ...
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="account" className="block rs-shell-account">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreButton id="usage" className="rs-shell-button rs-shell-usage" onAction={(...eventArgs) => _callAction("navigate", {}, eventArgs)} id="usage" label={undefined} theme="auto" />
</>)}
      ...
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="tools" className="rs-tools">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreBadge id="meter" className="inline-flex px-2.5 py-1 text-xs gap-1.5" ariaLabel="Remaining learning minutes" label="{{ Math.ceil((inputs.remainingSeconds || 0)/60) }} min" />
</>)}
</RudraLayoutBox>
</>)}
</RudraLayoutBox>
      ...
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="languages" role="group" aria-label="Language" className="block rs-shell-languages">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreButton id="locale_en" className="rs-shell-button rs-shell-language" lang="en" label="English" theme="auto" onAction={(...eventArgs) => _callAction("changeLocale", {}, eventArgs)} aria-pressed={undefined} id="locale_en" />
</>)}
