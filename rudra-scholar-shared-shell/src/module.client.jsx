...
export default function CompiledModule(props) {
  ...
  return (
    <div ref={wrapperRef} className="rudra-module-wrapper">
      ...
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="header" role="banner" className="block rs-shell-header">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="header_inner" className="block rs-shell-header-inner">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreButton id="brand" className="rs-shell-brand" theme="auto" onAction={(...eventArgs) => _callAction("navigate", {}, eventArgs)} id="brand" label="Rudra Scholar" />
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="navigation" role="navigation" aria-label="Main navigation" className="block rs-shell-nav">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreButton id="explore" className="rs-shell-button" onAction={(...eventArgs) => _callAction("navigate", {}, eventArgs)} id="explore" label="Explore" theme="auto" />
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreButton id="pricing" className="rs-shell-button" onAction={(...eventArgs) => _callAction("navigate", {}, eventArgs)} id="pricing" label="Learning time" theme="auto" />
</>)}
      {isVisibleValue(undefined) && (<>      <RudraCoreButton id="educator" className="rs-shell-button" onAction={(...eventArgs) => _callAction("navigate", {}, eventArgs)} id="educator" label="Educator studio" theme="auto" />
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="account" className="block rs-shell-account">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreButton id="usage" className="rs-shell-button rs-shell-usage" label={undefined} theme="auto" onAction={(...eventArgs) => _callAction("navigate", {}, eventArgs)} id="usage" />
</>)}
      {isVisibleValue(undefined) && (<>      <RudraCoreButton id="signin" className="rs-shell-button rs-shell-primary" onAction={(...eventArgs) => _callAction("signIn", {}, eventArgs)} id="signin" label="Sign in" theme="auto" />
</>)}
      ...
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutBox id="nav" className="rs-nav">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreButton id="home" variant="ghost" onAction={(...eventArgs) => _callAction("navigate", {}, eventArgs)} label={((_bindingValue) => _bindingValue === undefined ? "Home" : _bindingValue)(_scope?.i18n?.home)} theme="auto" />
</>)}
      ...
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreButton id="locale_hi" className="rs-shell-button rs-shell-language" label="हिन्दी" theme="auto" onAction={(...eventArgs) => _callAction("changeLocale", {}, eventArgs)} aria-pressed={undefined} id="locale_hi" lang="hi" />
</>)}
