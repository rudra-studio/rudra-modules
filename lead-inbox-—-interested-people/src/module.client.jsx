...
import { Flex as RudraLayoutFlex, ScrollArea as RudraLayoutScrollArea, Container as RudraLayoutContainer, Section as RudraLayoutSection, Grid as RudraLayoutGrid, Box as RudraLayoutBox } from '@rudra-studio/rudra-layout';
...
export default function CompiledModule(props) {
  ...
  return (
    <div ref={wrapperRef} className="rudra-module-wrapper">
      ...
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutGrid id="leads_kpi_grid" className={`grid flex ${getResponsiveProp({sm: 'grid grid-cols-1 gap-4', md: 'grid grid-cols-2 gap-4', lg: 'grid grid-cols-4 gap-4'}) || ''}`} as="div">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraWidgetsMetricCard id="leads_metric_total" className={`${getResponsiveProp({sm: 'leads-metric'}) || ''}`} valueClassName={`${getResponsiveProp({sm: 'leads-metric-value'}) || ''}`} chartClassName={`${getResponsiveProp({sm: 'leads-metric-chart'}) || ''}`} labelClassName={`${getResponsiveProp({sm: 'leads-metric-label'}) || ''}`} trendClassName={`${getResponsiveProp({sm: 'leads-metric-trend'}) || ''}`} descriptionClassName={`${getResponsiveProp({sm: 'leads-metric-description'}) || ''}`} style={{"background":"#0d1319","border":"1px solid rgba(98,217,255,.18)","borderRadius":"20px","padding":"20px"}} value={((_bindingValue) => _bindingValue === undefined ? 0 : _bindingValue)(leadAnalytics?.total_leads)} showChart={false} negativeColor="#fb7185" positiveColor="#6dffb8" label="Total leads" showTrend={false} accentColor="#62d9ff" description="Records matching the active filter" neutralColor="#62d9ff" />
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraWidgetsMetricCard id="leads_metric_new" trendClassName={`${getResponsiveProp({sm: 'leads-metric-trend'}) || ''}`} descriptionClassName={`${getResponsiveProp({sm: 'leads-metric-description'}) || ''}`} className={`${getResponsiveProp({sm: 'leads-metric'}) || ''}`} valueClassName={`${getResponsiveProp({sm: 'leads-metric-value'}) || ''}`} chartClassName={`${getResponsiveProp({sm: 'leads-metric-chart'}) || ''}`} labelClassName={`${getResponsiveProp({sm: 'leads-metric-label'}) || ''}`} style={{"background":"#0d1319","border":"1px solid rgba(98,217,255,.18)","borderRadius":"20px","padding":"20px"}} value={((_bindingValue) => _bindingValue === undefined ? 0 : _bindingValue)(leadAnalytics?.new_leads)} trendLabel="current queue" trendValue="Live" negativeColor="#fb7185" trend="up" showChart={false} positiveColor="#6dffb8" label="New leads" accentColor="#6dffb8" description="Awaiting first response" neutralColor="#62d9ff" showTrend={true} />
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraWidgetsMetricCard id="leads_metric_jobs" chartClassName={`${getResponsiveProp({sm: 'leads-metric-chart'}) || ''}`} labelClassName={`${getResponsiveProp({sm: 'leads-metric-label'}) || ''}`} trendClassName={`${getResponsiveProp({sm: 'leads-metric-trend'}) || ''}`} descriptionClassName={`${getResponsiveProp({sm: 'leads-metric-description'}) || ''}`} valueClassName={`${getResponsiveProp({sm: 'leads-metric-value'}) || ''}`} className={`${getResponsiveProp({sm: 'leads-metric'}) || ''}`} description="Career and hiring signals" positiveColor="#6dffb8" neutralColor="#62d9ff" style={{"background":"#0d1319","border":"1px solid rgba(98,217,255,.18)","borderRadius":"20px","padding":"20px"}} value={((_bindingValue) => _bindingValue === undefined ? 0 : _bindingValue)(leadAnalytics?.job_leads)} showChart={false} negativeColor="#fb7185" label="Job intent" showTrend={false} accentColor="#a78bfa" />
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraWidgetsMetricCard id="leads_metric_sources" className={`${getResponsiveProp({sm: 'leads-metric'}) || ''}`} valueClassName={`${getResponsiveProp({sm: 'leads-metric-value'}) || ''}`} chartClassName={`${getResponsiveProp({sm: 'leads-metric-chart'}) || ''}`} labelClassName={`${getResponsiveProp({sm: 'leads-metric-label'}) || ''}`} trendClassName={`${getResponsiveProp({sm: 'leads-metric-trend'}) || ''}`} descriptionClassName={`${getResponsiveProp({sm: 'leads-metric-description'}) || ''}`} value={((_bindingValue) => _bindingValue === undefined ? 0 : _bindingValue)(leadAnalytics?.active_sources)} showChart={false} accentColor="#fbbf24" label="Active sources" description="Distinct acquisition channels" showTrend={false} neutralColor="#62d9ff" positiveColor="#6dffb8" style={{"background":"#0d1319","border":"1px solid rgba(98,217,255,.18)","borderRadius":"20px","padding":"20px"}} negativeColor="#fb7185" />
</>)}
</RudraLayoutGrid>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutGrid id="leads_insight_grid" className={`${getResponsiveProp({sm: 'mt-4 grid grid-cols-1 gap-4', md: 'mt-4 grid grid-cols-2 gap-4', lg: 'mt-4 grid grid-cols-3 gap-4'}) || ''}`} as="div">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraWidgetsMetricCard id="leads_metric_volume" className={`${getResponsiveProp({sm: 'leads-metric'}) || ''}`} chartClassName={`${getResponsiveProp({sm: 'leads-metric-chart'}) || ''}`} labelClassName={`${getResponsiveProp({sm: 'leads-metric-label'}) || ''}`} trendClassName={`${getResponsiveProp({sm: 'leads-metric-trend'}) || ''}`} descriptionClassName={`${getResponsiveProp({sm: 'leads-metric-description'}) || ''}`} valueClassName={`${getResponsiveProp({sm: 'leads-metric-value'}) || ''}`} trend="neutral" value={((_bindingValue) => _bindingValue === undefined ? 0 : _bindingValue)(leadAnalytics?.total_leads)} description="Daily arrivals represented in the current result set" label="Lead volume" showChart={true} accentColor="#62d9ff" chartHeight={82} neutralColor="#62d9ff" style={{"background":"#0d1319","border":"1px solid rgba(98,217,255,.18)","borderRadius":"20px","padding":"20px"}} chartData={((_bindingValue) => _bindingValue === undefined ? [] : _bindingValue)(leadAnalytics?.daily_lead_counts)} showTrend={true} chartType="area" trendLabel="received in last 7 days" trendValue={((_bindingValue) => _bindingValue === undefined ? 0 : _bindingValue)(leadAnalytics?.leads_last_7_days)} negativeColor="#fb7185" positiveColor="#6dffb8" />
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraWidgetsMetricCard id="leads_metric_intents" labelClassName={`${getResponsiveProp({sm: 'leads-metric-label'}) || ''}`} trendClassName={`${getResponsiveProp({sm: 'leads-metric-trend'}) || ''}`} descriptionClassName={`${getResponsiveProp({sm: 'leads-metric-description'}) || ''}`} valueClassName={`${getResponsiveProp({sm: 'leads-metric-value'}) || ''}`} chartClassName={`${getResponsiveProp({sm: 'leads-metric-chart'}) || ''}`} className={`${getResponsiveProp({sm: 'leads-metric'}) || ''}`} accentColor="#a78bfa" negativeColor="#fb7185" label="Intent mix" value={((_bindingValue) => _bindingValue === undefined ? 0 : _bindingValue)(leadAnalytics?.project_leads)} showChart={true} showTrend={true} trendLabel="job leads" positiveColor="#6dffb8" style={{"background":"#0d1319","border":"1px solid rgba(98,217,255,.18)","borderRadius":"20px","padding":"20px"}} chartType="line" chartHeight={82} description="Project leads shown as the headline value" chartData={((_bindingValue) => _bindingValue === undefined ? [0, 0, 0] : _bindingValue)(leadAnalytics?.intent_counts)} neutralColor="#62d9ff" trend="neutral" trendValue={((_bindingValue) => _bindingValue === undefined ? 0 : _bindingValue)(leadAnalytics?.job_leads)} />
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraWidgetsMetricCard id="leads_metric_contact" className={`${getResponsiveProp({sm: 'leads-metric'}) || ''}`} labelClassName={`${getResponsiveProp({sm: 'leads-metric-label'}) || ''}`} trendClassName={`${getResponsiveProp({sm: 'leads-metric-trend'}) || ''}`} descriptionClassName={`${getResponsiveProp({sm: 'leads-metric-description'}) || ''}`} valueClassName={`${getResponsiveProp({sm: 'leads-metric-value'}) || ''}`} chartClassName={`${getResponsiveProp({sm: 'leads-metric-chart'}) || ''}`} trendLabel="progressed leads" label="Contact progress" suffix="%" showTrend={true} accentColor="#6dffb8" neutralColor="#62d9ff" positiveColor="#6dffb8" trend="up" showChart={false} description="Share moved beyond new status" negativeColor="#fb7185" trendValue={((_bindingValue) => _bindingValue === undefined ? 0 : _bindingValue)(leadAnalytics?.progressed_leads)} style={{"background":"#0d1319","border":"1px solid rgba(98,217,255,.18)","borderRadius":"20px","padding":"20px"}} value={((_bindingValue) => _bindingValue === undefined ? 0 : _bindingValue)(leadAnalytics?.contact_progress)} />
</>)}
</RudraLayoutGrid>
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreSurface id="leads_filters" className={`${getResponsiveProp({sm: 'leads-panel mt-12 rounded-[1.25rem] border border-[#6dffb8]/20 bg-[#0d1319] p-5 text-white', md: 'leads-panel mt-14 rounded-[1.5rem] border border-[#6dffb8]/20 bg-[#0d1319] p-7 text-white', lg: 'leads-panel mt-16 rounded-[1.5rem] border border-[#6dffb8]/20 bg-[#0d1319] p-8 text-white'}) || ''}`} theme="auto" as="section">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreTypography id="leads_filters_label" className="text-[10px] font-bold tracking-[.18em] text-[#6dffb8]" content="ACTIVE FILTERS" as="h2" />
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutFlex id="leads_filter_row" className="mt-5" direction="horizontal" as="div" gap="3" wrap={true}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreBadge id="leads_filter_intent" className="rounded-full border border-white/10 bg-white/5 px-4 py-2 text-white" size="md" label={intent} variant="outline" />
</>)}
      ...
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreBadge id="leads_filter_source" className="rounded-full border border-white/10 bg-white/5 px-4 py-2 text-white" label={source} variant="outline" size="md" />
</>)}
      ...
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutScrollArea id="leads_table_scroll" className="w-full overflow-x-auto" orientation="horizontal">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraWidgetsDataTable id="leads_table" className="min-w-[880px]" mode="pagination" columns={[{"accessorKey":"full_name","header":"Name"},{"accessorKey":"email","header":"Email"},{"accessorKey":"company","header":"Company"},{"accessorKey":"intent","header":"Intent"},{"accessorKey":"source","header":"Source"},{"accessorKey":"status","header":"Status"},{"accessorKey":"created_at","header":"Received"}]} pageSize={10} globalFilterPlaceholder="Search leads" data={leads} />
</>)}
      ...
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutFlex id="leads_footer" className="mt-12 border-t border-white/10 pt-5" direction="horizontal" as="footer" gap="4" wrap={true} justify="between">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreTypography id="leads_footer_security" className="text-[10px] font-bold tracking-[.16em] text-[#6dffb8]" as="p" content="PRIVATE ROUTE · AUTH REQUIRED" />
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreTypography id="leads_footer_brand" className="text-[10px] font-bold tracking-[.16em] text-white/35" content="RUDRA LEAD SYSTEM · 2026" as="p" />
</>)}
</RudraLayoutFlex>
</>)}
