...
import { ScrollArea as RudraLayoutScrollArea, Container as RudraLayoutContainer, Section as RudraLayoutSection, Grid as RudraLayoutGrid, Box as RudraLayoutBox, Flex as RudraLayoutFlex } from '@rudra-studio/rudra-layout';
...
export default function CompiledModule(props) {
  ...
  return (
    <div ref={wrapperRef} className="rudra-module-wrapper">
      ...
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutSection id="leads_main" className={`${getResponsiveProp({sm: 'px-4 py-14', md: 'px-8 py-20', lg: 'px-12 py-24'}) || ''}`} as="section">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutContainer id="leads_container" className="w-full max-w-[1500px]" maxWidth="full" centered={true}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutFlex id="leads_meta" className="border-t border-[#6dffb8]/25 pt-3" gap="4" wrap={true} align="center" justify="between" direction="horizontal" as="div">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreTypography id="leads_kicker" className="leads-signal ml-5 text-[10px] font-bold tracking-[.18em] text-[#6dffb8]" as="p" content="LIVE INTAKE · SERVER-RENDERED · FILTERED" />
</>)}
      ...
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutGrid id="leads_kpi_grid" className={`grid flex ${getResponsiveProp({sm: 'grid grid-cols-1 gap-4', md: 'grid grid-cols-2 gap-4', lg: 'grid grid-cols-4 gap-4'}) || ''}`} as="div">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraWidgetsMetricCard id="leads_metric_total" className={`${getResponsiveProp({sm: 'leads-metric'}) || ''}`} chartClassName={`${getResponsiveProp({sm: 'leads-metric-chart'}) || ''}`} trendClassName={`${getResponsiveProp({sm: 'leads-metric-trend'}) || ''}`} descriptionClassName={`${getResponsiveProp({sm: 'leads-metric-description'}) || ''}`} labelClassName={`${getResponsiveProp({sm: 'leads-metric-label'}) || ''}`} valueClassName={`${getResponsiveProp({sm: 'leads-metric-value'}) || ''}`} value={((_bindingValue) => _bindingValue === undefined ? 0 : _bindingValue)(leadAnalytics?.total_leads)} showChart={false} label="Total leads" negativeColor="#fb7185" showTrend={false} neutralColor="#62d9ff" positiveColor="#6dffb8" accentColor="#62d9ff" description="Records matching the active filter" style={{"background":"#0d1319","border":"1px solid rgba(98,217,255,.18)","borderRadius":"20px","padding":"20px"}} />
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraWidgetsMetricCard id="leads_metric_new" chartClassName={`${getResponsiveProp({sm: 'leads-metric-chart'}) || ''}`} trendClassName={`${getResponsiveProp({sm: 'leads-metric-trend'}) || ''}`} descriptionClassName={`${getResponsiveProp({sm: 'leads-metric-description'}) || ''}`} labelClassName={`${getResponsiveProp({sm: 'leads-metric-label'}) || ''}`} className={`${getResponsiveProp({sm: 'leads-metric'}) || ''}`} valueClassName={`${getResponsiveProp({sm: 'leads-metric-value'}) || ''}`} trendValue="Live" positiveColor="#6dffb8" trend="up" showChart={false} description="Awaiting first response" negativeColor="#fb7185" style={{"background":"#0d1319","border":"1px solid rgba(98,217,255,.18)","borderRadius":"20px","padding":"20px"}} value={((_bindingValue) => _bindingValue === undefined ? 0 : _bindingValue)(leadAnalytics?.new_leads)} neutralColor="#62d9ff" label="New leads" showTrend={true} trendLabel="current queue" accentColor="#6dffb8" />
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraWidgetsMetricCard id="leads_metric_jobs" className={`${getResponsiveProp({sm: 'leads-metric'}) || ''}`} valueClassName={`${getResponsiveProp({sm: 'leads-metric-value'}) || ''}`} chartClassName={`${getResponsiveProp({sm: 'leads-metric-chart'}) || ''}`} trendClassName={`${getResponsiveProp({sm: 'leads-metric-trend'}) || ''}`} descriptionClassName={`${getResponsiveProp({sm: 'leads-metric-description'}) || ''}`} labelClassName={`${getResponsiveProp({sm: 'leads-metric-label'}) || ''}`} showChart={false} neutralColor="#62d9ff" label="Job intent" showTrend={false} accentColor="#a78bfa" description="Career and hiring signals" value={((_bindingValue) => _bindingValue === undefined ? 0 : _bindingValue)(leadAnalytics?.job_leads)} negativeColor="#fb7185" positiveColor="#6dffb8" style={{"background":"#0d1319","border":"1px solid rgba(98,217,255,.18)","borderRadius":"20px","padding":"20px"}} />
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraWidgetsMetricCard id="leads_metric_sources" descriptionClassName={`${getResponsiveProp({sm: 'leads-metric-description'}) || ''}`} labelClassName={`${getResponsiveProp({sm: 'leads-metric-label'}) || ''}`} valueClassName={`${getResponsiveProp({sm: 'leads-metric-value'}) || ''}`} className={`${getResponsiveProp({sm: 'leads-metric'}) || ''}`} chartClassName={`${getResponsiveProp({sm: 'leads-metric-chart'}) || ''}`} trendClassName={`${getResponsiveProp({sm: 'leads-metric-trend'}) || ''}`} label="Active sources" value={((_bindingValue) => _bindingValue === undefined ? 0 : _bindingValue)(leadAnalytics?.active_sources)} accentColor="#fbbf24" description="Distinct acquisition channels" showTrend={false} negativeColor="#fb7185" positiveColor="#6dffb8" neutralColor="#62d9ff" style={{"background":"#0d1319","border":"1px solid rgba(98,217,255,.18)","borderRadius":"20px","padding":"20px"}} showChart={false} />
</>)}
</RudraLayoutGrid>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutGrid id="leads_insight_grid" className={`${getResponsiveProp({sm: 'mt-4 grid grid-cols-1 gap-4', md: 'mt-4 grid grid-cols-2 gap-4', lg: 'mt-4 grid grid-cols-3 gap-4'}) || ''}`} as="div">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraWidgetsMetricCard id="leads_metric_volume" valueClassName={`${getResponsiveProp({sm: 'leads-metric-value'}) || ''}`} chartClassName={`${getResponsiveProp({sm: 'leads-metric-chart'}) || ''}`} trendClassName={`${getResponsiveProp({sm: 'leads-metric-trend'}) || ''}`} descriptionClassName={`${getResponsiveProp({sm: 'leads-metric-description'}) || ''}`} labelClassName={`${getResponsiveProp({sm: 'leads-metric-label'}) || ''}`} className={`${getResponsiveProp({sm: 'leads-metric'}) || ''}`} accentColor="#62d9ff" description="Daily arrivals represented in the current result set" style={{"background":"#0d1319","border":"1px solid rgba(98,217,255,.18)","borderRadius":"20px","padding":"20px"}} chartHeight={82} negativeColor="#fb7185" chartType="area" neutralColor="#62d9ff" positiveColor="#6dffb8" label="Lead volume" trendLabel="received in last 7 days" trendValue={((_bindingValue) => _bindingValue === undefined ? 0 : _bindingValue)(leadAnalytics?.leads_last_7_days)} trend="neutral" value={((_bindingValue) => _bindingValue === undefined ? 0 : _bindingValue)(leadAnalytics?.total_leads)} chartData={((_bindingValue) => _bindingValue === undefined ? [] : _bindingValue)(leadAnalytics?.daily_lead_counts)} showChart={true} showTrend={true} />
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraWidgetsMetricCard id="leads_metric_intents" labelClassName={`${getResponsiveProp({sm: 'leads-metric-label'}) || ''}`} valueClassName={`${getResponsiveProp({sm: 'leads-metric-value'}) || ''}`} className={`${getResponsiveProp({sm: 'leads-metric'}) || ''}`} chartClassName={`${getResponsiveProp({sm: 'leads-metric-chart'}) || ''}`} trendClassName={`${getResponsiveProp({sm: 'leads-metric-trend'}) || ''}`} descriptionClassName={`${getResponsiveProp({sm: 'leads-metric-description'}) || ''}`} label="Intent mix" chartType="line" showChart={true} showTrend={true} positiveColor="#6dffb8" chartData={((_bindingValue) => _bindingValue === undefined ? [0, 0, 0] : _bindingValue)(leadAnalytics?.intent_counts)} trendLabel="job leads" trendValue={((_bindingValue) => _bindingValue === undefined ? 0 : _bindingValue)(leadAnalytics?.job_leads)} description="Project leads shown as the headline value" negativeColor="#fb7185" style={{"background":"#0d1319","border":"1px solid rgba(98,217,255,.18)","borderRadius":"20px","padding":"20px"}} trend="neutral" value={((_bindingValue) => _bindingValue === undefined ? 0 : _bindingValue)(leadAnalytics?.project_leads)} accentColor="#a78bfa" neutralColor="#62d9ff" chartHeight={82} />
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraWidgetsMetricCard id="leads_metric_contact" valueClassName={`${getResponsiveProp({sm: 'leads-metric-value'}) || ''}`} className={`${getResponsiveProp({sm: 'leads-metric'}) || ''}`} chartClassName={`${getResponsiveProp({sm: 'leads-metric-chart'}) || ''}`} trendClassName={`${getResponsiveProp({sm: 'leads-metric-trend'}) || ''}`} descriptionClassName={`${getResponsiveProp({sm: 'leads-metric-description'}) || ''}`} labelClassName={`${getResponsiveProp({sm: 'leads-metric-label'}) || ''}`} description="Share moved beyond new status" style={{"background":"#0d1319","border":"1px solid rgba(98,217,255,.18)","borderRadius":"20px","padding":"20px"}} value={((_bindingValue) => _bindingValue === undefined ? 0 : _bindingValue)(leadAnalytics?.contact_progress)} negativeColor="#fb7185" trend="up" showChart={false} showTrend={true} trendLabel="progressed leads" positiveColor="#6dffb8" label="Contact progress" accentColor="#6dffb8" neutralColor="#62d9ff" suffix="%" trendValue={((_bindingValue) => _bindingValue === undefined ? 0 : _bindingValue)(leadAnalytics?.progressed_leads)} />
</>)}
</RudraLayoutGrid>
</>)}
</RudraLayoutBox>
      ...
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreBadge id="leads_filter_status" className="rounded-full border border-white/10 bg-white/5 px-4 py-2 text-white" label={status} variant="outline" size="md" />
</>)}
      ...
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutScrollArea id="leads_table_scroll" className="w-full overflow-x-auto" orientation="horizontal">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraWidgetsDataTable id="leads_table" className="min-w-[880px]" columns={[{"accessorKey":"full_name","header":"Name"},{"accessorKey":"email","header":"Email"},{"accessorKey":"company","header":"Company"},{"accessorKey":"intent","header":"Intent"},{"accessorKey":"source","header":"Source"},{"accessorKey":"status","header":"Status"},{"accessorKey":"created_at","header":"Received"}]} pageSize={10} globalFilterPlaceholder="Search leads" data={leads} mode="pagination" />
</>)}
      ...
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutFlex id="leads_footer" className="mt-12 border-t border-white/10 pt-5" gap="4" wrap={true} justify="between" direction="horizontal" as="footer">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreTypography id="leads_footer_security" className="text-[10px] font-bold tracking-[.16em] text-[#6dffb8]" as="p" content="PRIVATE ROUTE · AUTH REQUIRED" />
</>)}
