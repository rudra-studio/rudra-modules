...
export default function CompiledModule(props) {
  ...
  return (
    <div ref={wrapperRef} className="rudra-module-wrapper">
      ...
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreTypography id="leads_sort_note" className={`grid ${getResponsiveProp({sm: 'text-[10px] font-bold tracking-[.16em] text-[#62d9ff]', md: 'text-right text-[10px] font-bold tracking-[.16em] text-[#62d9ff]', lg: 'col-span-5 text-right text-[10px] font-bold tracking-[.16em] text-[#62d9ff]'}) || ''}`} content="SORTED · NEWEST FIRST" as="p" />
</>)}
</RudraLayoutGrid>
</>)}
      ...
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutGrid id="leads_kpi_grid" className={`grid flex ${getResponsiveProp({sm: 'grid grid-cols-1 gap-4', md: 'grid grid-cols-2 gap-4', lg: 'grid grid-cols-4 gap-4'}) || ''}`} as="div">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraWidgetsMetricCard id="leads_metric_total" chartClassName={`${getResponsiveProp({sm: 'leads-metric-chart'}) || ''}`} valueClassName={`${getResponsiveProp({sm: 'leads-metric-value'}) || ''}`} labelClassName={`${getResponsiveProp({sm: 'leads-metric-label'}) || ''}`} descriptionClassName={`${getResponsiveProp({sm: 'leads-metric-description'}) || ''}`} trendClassName={`${getResponsiveProp({sm: 'leads-metric-trend'}) || ''}`} className={`${getResponsiveProp({sm: 'leads-metric'}) || ''}`} negativeColor="#fb7185" style={{"background":"#0d1319","border":"1px solid rgba(98,217,255,.18)","borderRadius":"20px","padding":"20px"}} showChart={false} accentColor="#62d9ff" neutralColor="#62d9ff" positiveColor="#6dffb8" label="Total leads" value={((_bindingValue) => _bindingValue === undefined ? 0 : _bindingValue)(leadAnalytics?.total_leads)} showTrend={false} description="Records matching the active filter" />
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraWidgetsMetricCard id="leads_metric_new" className={`${getResponsiveProp({sm: 'leads-metric'}) || ''}`} chartClassName={`${getResponsiveProp({sm: 'leads-metric-chart'}) || ''}`} valueClassName={`${getResponsiveProp({sm: 'leads-metric-value'}) || ''}`} labelClassName={`${getResponsiveProp({sm: 'leads-metric-label'}) || ''}`} descriptionClassName={`${getResponsiveProp({sm: 'leads-metric-description'}) || ''}`} trendClassName={`${getResponsiveProp({sm: 'leads-metric-trend'}) || ''}`} style={{"background":"#0d1319","border":"1px solid rgba(98,217,255,.18)","borderRadius":"20px","padding":"20px"}} trendValue="Live" value={((_bindingValue) => _bindingValue === undefined ? 0 : _bindingValue)(leadAnalytics?.new_leads)} showTrend={true} description="Awaiting first response" negativeColor="#fb7185" trend="up" accentColor="#6dffb8" neutralColor="#62d9ff" showChart={false} trendLabel="current queue" positiveColor="#6dffb8" label="New leads" />
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraWidgetsMetricCard id="leads_metric_jobs" labelClassName={`${getResponsiveProp({sm: 'leads-metric-label'}) || ''}`} className={`${getResponsiveProp({sm: 'leads-metric'}) || ''}`} descriptionClassName={`${getResponsiveProp({sm: 'leads-metric-description'}) || ''}`} trendClassName={`${getResponsiveProp({sm: 'leads-metric-trend'}) || ''}`} chartClassName={`${getResponsiveProp({sm: 'leads-metric-chart'}) || ''}`} valueClassName={`${getResponsiveProp({sm: 'leads-metric-value'}) || ''}`} style={{"background":"#0d1319","border":"1px solid rgba(98,217,255,.18)","borderRadius":"20px","padding":"20px"}} value={((_bindingValue) => _bindingValue === undefined ? 0 : _bindingValue)(leadAnalytics?.job_leads)} showChart={false} showTrend={false} negativeColor="#fb7185" description="Career and hiring signals" positiveColor="#6dffb8" label="Job intent" neutralColor="#62d9ff" accentColor="#a78bfa" />
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraWidgetsMetricCard id="leads_metric_sources" className={`${getResponsiveProp({sm: 'leads-metric'}) || ''}`} trendClassName={`${getResponsiveProp({sm: 'leads-metric-trend'}) || ''}`} chartClassName={`${getResponsiveProp({sm: 'leads-metric-chart'}) || ''}`} valueClassName={`${getResponsiveProp({sm: 'leads-metric-value'}) || ''}`} labelClassName={`${getResponsiveProp({sm: 'leads-metric-label'}) || ''}`} descriptionClassName={`${getResponsiveProp({sm: 'leads-metric-description'}) || ''}`} showChart={false} negativeColor="#fb7185" accentColor="#fbbf24" label="Active sources" style={{"background":"#0d1319","border":"1px solid rgba(98,217,255,.18)","borderRadius":"20px","padding":"20px"}} positiveColor="#6dffb8" value={((_bindingValue) => _bindingValue === undefined ? 0 : _bindingValue)(leadAnalytics?.active_sources)} showTrend={false} description="Distinct acquisition channels" neutralColor="#62d9ff" />
</>)}
</RudraLayoutGrid>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutGrid id="leads_insight_grid" className={`${getResponsiveProp({sm: 'mt-4 grid grid-cols-1 gap-4', md: 'mt-4 grid grid-cols-2 gap-4', lg: 'mt-4 grid grid-cols-3 gap-4'}) || ''}`} as="div">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraWidgetsMetricCard id="leads_metric_volume" descriptionClassName={`${getResponsiveProp({sm: 'leads-metric-description'}) || ''}`} className={`${getResponsiveProp({sm: 'leads-metric'}) || ''}`} trendClassName={`${getResponsiveProp({sm: 'leads-metric-trend'}) || ''}`} chartClassName={`${getResponsiveProp({sm: 'leads-metric-chart'}) || ''}`} valueClassName={`${getResponsiveProp({sm: 'leads-metric-value'}) || ''}`} labelClassName={`${getResponsiveProp({sm: 'leads-metric-label'}) || ''}`} trend="neutral" chartType="area" label="Lead volume" neutralColor="#62d9ff" negativeColor="#fb7185" style={{"background":"#0d1319","border":"1px solid rgba(98,217,255,.18)","borderRadius":"20px","padding":"20px"}} showChart={true} trendValue={((_bindingValue) => _bindingValue === undefined ? 0 : _bindingValue)(leadAnalytics?.leads_last_7_days)} description="Daily arrivals represented in the current result set" positiveColor="#6dffb8" value={((_bindingValue) => _bindingValue === undefined ? 0 : _bindingValue)(leadAnalytics?.total_leads)} chartData={((_bindingValue) => _bindingValue === undefined ? [] : _bindingValue)(leadAnalytics?.daily_lead_counts)} showTrend={true} trendLabel="received in last 7 days" accentColor="#62d9ff" chartHeight={82} />
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraWidgetsMetricCard id="leads_metric_intents" labelClassName={`${getResponsiveProp({sm: 'leads-metric-label'}) || ''}`} descriptionClassName={`${getResponsiveProp({sm: 'leads-metric-description'}) || ''}`} className={`${getResponsiveProp({sm: 'leads-metric'}) || ''}`} trendClassName={`${getResponsiveProp({sm: 'leads-metric-trend'}) || ''}`} chartClassName={`${getResponsiveProp({sm: 'leads-metric-chart'}) || ''}`} valueClassName={`${getResponsiveProp({sm: 'leads-metric-value'}) || ''}`} trend="neutral" value={((_bindingValue) => _bindingValue === undefined ? 0 : _bindingValue)(leadAnalytics?.project_leads)} chartType="line" showChart={true} description="Project leads shown as the headline value" trendLabel="job leads" neutralColor="#62d9ff" negativeColor="#fb7185" showTrend={true} label="Intent mix" chartData={((_bindingValue) => _bindingValue === undefined ? [0, 0, 0] : _bindingValue)(leadAnalytics?.intent_counts)} trendValue={((_bindingValue) => _bindingValue === undefined ? 0 : _bindingValue)(leadAnalytics?.job_leads)} accentColor="#a78bfa" chartHeight={82} positiveColor="#6dffb8" style={{"background":"#0d1319","border":"1px solid rgba(98,217,255,.18)","borderRadius":"20px","padding":"20px"}} />
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraWidgetsMetricCard id="leads_metric_contact" chartClassName={`${getResponsiveProp({sm: 'leads-metric-chart'}) || ''}`} valueClassName={`${getResponsiveProp({sm: 'leads-metric-value'}) || ''}`} className={`${getResponsiveProp({sm: 'leads-metric'}) || ''}`} labelClassName={`${getResponsiveProp({sm: 'leads-metric-label'}) || ''}`} descriptionClassName={`${getResponsiveProp({sm: 'leads-metric-description'}) || ''}`} trendClassName={`${getResponsiveProp({sm: 'leads-metric-trend'}) || ''}`} positiveColor="#6dffb8" trend="up" trendValue={((_bindingValue) => _bindingValue === undefined ? 0 : _bindingValue)(leadAnalytics?.progressed_leads)} accentColor="#6dffb8" label="Contact progress" style={{"background":"#0d1319","border":"1px solid rgba(98,217,255,.18)","borderRadius":"20px","padding":"20px"}} value={((_bindingValue) => _bindingValue === undefined ? 0 : _bindingValue)(leadAnalytics?.contact_progress)} showChart={false} showTrend={true} trendLabel="progressed leads" description="Share moved beyond new status" neutralColor="#62d9ff" suffix="%" negativeColor="#fb7185" />
</>)}
</RudraLayoutGrid>
</>)}
</RudraLayoutBox>
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreSurface id="leads_filters" className={`${getResponsiveProp({sm: 'leads-panel mt-12 rounded-[1.25rem] border border-[#6dffb8]/20 bg-[#0d1319] p-5 text-white', md: 'leads-panel mt-14 rounded-[1.5rem] border border-[#6dffb8]/20 bg-[#0d1319] p-7 text-white', lg: 'leads-panel mt-16 rounded-[1.5rem] border border-[#6dffb8]/20 bg-[#0d1319] p-8 text-white'}) || ''}`} as="section" theme="auto">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreTypography id="leads_filters_label" className="text-[10px] font-bold tracking-[.18em] text-[#6dffb8]" content="ACTIVE FILTERS" as="h2" />
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutFlex id="leads_filter_row" className="mt-5" as="div" gap="3" wrap={true} direction="horizontal">      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreBadge id="leads_filter_intent" className="rounded-full border border-white/10 bg-white/5 px-4 py-2 text-white" variant="outline" size="md" label={intent} />
</>)}
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreBadge id="leads_filter_status" className="rounded-full border border-white/10 bg-white/5 px-4 py-2 text-white" variant="outline" size="md" label={status} />
</>)}
      ...
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreBadge id="leads_filter_from" className="rounded-full border border-white/10 bg-white/5 px-4 py-2 text-white" variant="outline" size="md" label={from} />
</>)}
      ...
      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraLayoutFlex id="leads_footer" className="mt-12 border-t border-white/10 pt-5" justify="between" direction="horizontal" as="footer" gap="4" wrap={true}>      {isVisibleValue(getResponsiveProp({ "lg": true, "md": true, "sm": true })) && (<>      <RudraCoreTypography id="leads_footer_security" className="text-[10px] font-bold tracking-[.16em] text-[#6dffb8]" as="p" content="PRIVATE ROUTE · AUTH REQUIRED" />
</>)}
